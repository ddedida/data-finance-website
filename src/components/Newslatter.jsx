            ...
            <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
                ...
                <div className="my-4">
                    <div className="flex flex-col sm:flex-row items-center justify-between w-full">
                        ...
                        <button className="bg-[#00df9a] w-[200px] rounded-md font-medium ml-4 my-6 py-3 text-black hover:bg-[#4ddaad] hover:text-white hover:ease-in-out hover:duration-150">Notify Me</button>
                    </div>
                    <p>
